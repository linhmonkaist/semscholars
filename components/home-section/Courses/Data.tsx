...
export const featuredCourses = [
    {
      id: 1,
      title: "Tư vấn apply",
      description: "Được trực tiếp giải đáp các thắc mắc, đánh giá hồ sơ, định hướng chiến lược apply học bổng, tư vấn các gói mentor phù hợp...",
      image: "/assets/img/consult.png?height=200&width=300",
      category: "Gói lẻ",
      level: "150,000 VND",
      students: "",
